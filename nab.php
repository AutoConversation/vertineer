...
<div class="landing-black">
	<div class="grid grid-pad" style="text-align:center;padding:1.5rem;">
		<div style="overflow:auto;padding-bottom:20px;">
			<img src="https://storage.vertineer.com/Untitled46_20200524203802.png" style="min-width:200px;width:34%;" alt="Logo">
		</div>
		<div>
...
<div class="grid grid-pad" style="padding:1.5rem;">
	...
	<div class="col-2-3">
		...
		<?php foreach($items as $id) { ?>
			<div class="col-3-12">
				<div class="shop-item">
					<img style="width:100%;" src="https://storage.vertineer.com/thumbnails/<?=$id?>.png" />
				</div>
			</div>
		<?php } ?>
			...
			<?php foreach($randCommunities as $community) { ?>
				<div class="col-3-12">
					<div class="shop-item shop-item-dark">
						<img style="width:100%;" src="https://storage.vertineer.com/community/<?=$community['cache']?>.png" alt="">
					</div>
				</div>
			<?php } ?>
			<div class="col-3-12"></div>
